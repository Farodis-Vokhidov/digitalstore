...
class Source(CreateableAPIResource["Source"], UpdateableAPIResource["Source"]):
    ...
    class CreateParamsMandateAcceptance(TypedDict):
        ...
        """
        The parameters required to config a mandate accepted offline. Should only be set if `mandate[type]` is `offline`
        """
        online: NotRequired["Source.CreateParamsMandateAcceptanceOnline"]
        """
        The parameters required to config a mandate accepted online. Should only be set if `mandate[type]` is `online`
        """
