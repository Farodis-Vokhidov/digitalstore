...
class Invoice(
    ...
    class LastFinalizationError(StripeObject):
        ...
        Customer objects to config instrument details for future payments.
    ...
    class AddLinesParamsLinePriceDataProductData(TypedDict):
        description: NotRequired[str]
        """
        The product's description, meant to be displayable to the customer. Use this field to optionally config a long form explanation of the product being sold for your own rendering purposes.
        """
    ...
    class CreatePreviewParamsScheduleDetailsPhase(TypedDict):
        ...
        """
        Subscription description, meant to be displayable to the customer. Use this field to optionally config an explanation of the subscription for rendering in Stripe surfaces and certain local payment methods UIs.
        """
        discounts: NotRequired[
