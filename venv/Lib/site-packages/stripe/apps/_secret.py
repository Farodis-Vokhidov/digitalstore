...
class Secret(CreateableAPIResource["Secret"], ListableAPIResource["Secret"]):
    ...
    def create(cls, **params: Unpack["Secret.CreateParams"]) -> "Secret":
        """
        Create or replace a secret in the secret config.
        """
        return cast(
            "Secret",
            cls._static_request(
    ...
    def delete_where(
        ...
        """
        Deletes a secret from the secret config by name and scope.
        """
        return cast(
            "Secret",
            cls._static_request(
    ...
    def find(cls, **params: Unpack["Secret.FindParams"]) -> "Secret":
        """
        Finds a secret in the secret config by name and scope.
        """
        return cast(
            "Secret",
            cls._static_request(
