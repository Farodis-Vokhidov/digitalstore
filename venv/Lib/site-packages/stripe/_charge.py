    ...
    class PaymentMethodDetails(StripeObject):
        ...
        class Konbini(StripeObject):
            class Store(StripeObject):
                ...
                """
                The name of the convenience config chain where the payment was completed.
                """

            store: Optional[Store]
            """
            If the payment succeeded, this contains the details of the convenience config where the payment was completed.
            """
            _inner_class_types = {"config": Store}
