...
class Token(CreateableAPIResource["Token"]):
    ...
    You can't config or use tokens more than once. To config card or bank account
    ...
    card: Optional["Card"]
    """
    You can config multiple cards on a customer in order to charge the customer
    later. You can also config multiple debit cards on a recipient in order to
